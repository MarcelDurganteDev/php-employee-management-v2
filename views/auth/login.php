                        ...
                        <div class="card bg-dark text-white" style="border-radius: 1rem;">
                            <div class="card-body p-5 text-center">
                                <div class="mb-md-5 mt-md-4 pb-5">
                                    ...
                                    <form action="<?= Url::asset('/auth/auth');?>" method="post">
                                        <div class="form-outline form-white mb-4">
                                            <input name="email" placeholder="Email" type="email" id="typeEmailX" class="form-control form-control-lg" required>
                                ...
                                <div class="mb-5">
                                    <p class="mb-0">Don't have an account? <a href="<?= Url::asset('/auth/register');?>" class="text-white-50 fw-bold">Sign Up</a></p>
                                </div>
                            </div>
                        </div>
                    </div>
